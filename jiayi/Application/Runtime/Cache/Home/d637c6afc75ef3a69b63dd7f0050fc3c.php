...
<body>
  ...
  <input type="text" class="form-control" placeholder="关键字" id="achievementkey" name="achievementkey">
   ...
   <table class="table table-hover table-condensed">
        <thead>
          <tr>
            ...
            <th class="realname">学生姓名</th>
            <th class="competition">竞赛名</th>
            <th class="achievement">竞赛成绩</th>
            <th class="op">操作</th>
          </tr>
        </thead>
        <tbody>
          
          <?php if(is_array($achievement)): $i = 0; $__LIST__ = $achievement;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($vo["id"]); ?></td>
            <td><?php echo ($vo["username"]); ?></td>
            <td><?php echo ($vo["realname"]); ?></td>
            <td><?php echo ($vo["achievementname"]); ?></td>
  ...
  <button type="button" class="btn btn-default btn-sm btn-del" value="<?php echo ($vo["id"]); ?>">删除</button>
   ...
   <ul class="pagination">      
 <?php $__FOR_START_1055863071__=1;$__FOR_END_1055863071__=$pagenumber;for($i=$__FOR_START_1055863071__;$i < $__FOR_END_1055863071__;$i+=1){ ?><li><a href="/jiayi/index.php/Home/Admin/achievementlist/page/<?php echo ($i); ?>/searchkey/<?php echo ($searchkey); ?>/"><?php echo ($i); ?></a></li><?php } ?>
   </ul>
    </div>
  ...
  <div class="modal-dialog">
    ...
    <script>
        ...
        var key=$("#achievementkey").val();
         window.location.href="/jiayi/index.php/Home/Admin/achievementlist/searchkey/"+key; 
       })

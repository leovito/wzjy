  ...
  <div class="clear"></div>
    ...
    <div class="scontainer">
        ...
        <tbody>
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$volist): $mod = ($i % 2 );++$i;?><tr>
                
            <td><?php echo ($volist["type"]); ?></td>
            <td><a class="lista" href="/jiayi/index.php/Home/Index/article/articleid/<?php echo ($volist["id"]); ?>"><?php echo ($volist["title"]); ?></a></td>
            <td><?php echo (date("y-m-d",$volist["time"])); ?></td>
   ...
   <ul class="pagination">      
 <?php $__FOR_START_1636796319__=1;$__FOR_END_1636796319__=$pagenumber;for($i=$__FOR_START_1636796319__;$i < $__FOR_END_1636796319__;$i+=1){ ?><li><a href="/jiayi/index.php/Home/Index/articlelist/type/<?php echo ($type); ?>/page/<?php echo ($i); ?>"><?php echo ($i); ?></a></li><?php } ?>
   </ul>

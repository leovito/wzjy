...
<body>
  ...
  <button class="btn btn-danger btn-xs btn-del" value="<?php echo ($vo["id"]); ?>">删除</button>
    ...
    <ul class="pagination">      
 <?php $__FOR_START_378886051__=1;$__FOR_END_378886051__=$pagenumber;for($i=$__FOR_START_378886051__;$i < $__FOR_END_378886051__;$i+=1){ ?><li><a href="/jiayi/index.php/Home/Admin/testlist/page/<?php echo ($i); ?>/searchkey/<?php echo ($searchkey); ?>/"><?php echo ($i); ?></a></li><?php } ?>
   </ul>
        </div>
    </div>
  ...
  <div class="modal-dialog">
    ...
    <script>
        ...
        var key=$("#testkey").val();
         window.location.href="/jiayi/index.php/Home/Admin/testlist/searchkey/"+key; 
       })
        ...
        $.ajax({
   type: "POST",
   url: "/jiayi/index.php/Home/Admin/testdel",
   data: "id="+id,

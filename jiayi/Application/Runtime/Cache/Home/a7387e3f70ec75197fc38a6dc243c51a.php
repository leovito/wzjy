...
<body>
  ...
  <div class="clear"></div>
    ...
    <div class="scontainer">
        <div class="sct">
            <div class="sidebar">
                <?php if(is_array($schools)): $i = 0; $__LIST__ = $schools;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vosn): $mod = ($i % 2 );++$i;?><a href="/jiayi/index.php/Home/Index/schoollist/articleid/<?php echo ($vosn["articleid"]); ?>"><div class="sidebarblock">
                    <span class="glyphicon glyphicon-inbox"></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vosn["schoolname"]); ?>
  ...
  <div class="carousel-inner">
    ...
    <?php if(is_array($schools)): $i = 0; $__LIST__ = $schools;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><div class="item">
            <a href="/jiayi/index.php/Home/Index/schoollist/articleid/<?php echo ($vos["articleid"]); ?>}"><img src='/jiayi/Uploads<?php echo ($vos["photo"]); ?>' style="width:100%;height: 240px;"></a>
      ...
      <div class="carousel-caption">
            ...
            <h4 class="text-primary">新校区推荐</h4>
            <hr class="greyhr">
            <div id="newschoollist">
                
                <?php if(is_array($recommends)): $i = 0; $__LIST__ = $recommends;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vors): $mod = ($i % 2 );++$i;?><div class="nslitem">
                    <a href="/jiayi/index.php/Home/Index/schoollist/articleid/<?php echo ($vors["articleid"]); ?>">
                    <img class="simg" src="/jiayi/Uploads<?php echo ($vors["photo"]); ?>">
                        <h5 class="text-muted text-center"><?php echo ($vors["schoolname"]); ?></h5>
                        </a>
                </div><?php endforeach; endif; else: echo "" ;endif; ?>

...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li ><a href="/jiayi/index.php/Home/User/studentinfo">学生信息查询</a></li>
    ...
    <div class="container" id="mainct">
        ...
        <div class="list-group">
            <a href="/jiayi/index.php/Home/User/teacherindex/type/side1" class="list-group-item active">最新公告</a>
            <a href="/jiayi/index.php/Home/User/teacherindex/type/side2" class="list-group-item">成绩查询</a>
            <a href="/jiayi/index.php/Home/User/teacherindex/type/side3" class="list-group-item">使用说明</a>

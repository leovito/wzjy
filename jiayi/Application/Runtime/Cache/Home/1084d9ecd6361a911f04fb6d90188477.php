...
<body>
  ...
  <input type="text" class="form-control" placeholder="关键字" id="classkey" name="classkey">
   ...
   <table class="table table-hover table-condensed">
        ...
        <tbody>
          ...
          <?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
  ...
  <button type="button" class="btn btn-danger btn-xs btn-del" value="<?php echo ($vo["id"]); ?>">删除</button>
      ...
      <ul class="pagination"> 
 <?php $__FOR_START_536236784__=1;$__FOR_END_536236784__=$pagenumber;for($i=$__FOR_START_536236784__;$i < $__FOR_END_536236784__;$i+=1){ ?><li><a href="/jiayi/index.php/Home/Admin/classlist/page/<?php echo ($i); ?>/searchkey/<?php echo ($searchkey); ?>/"><?php echo ($i); ?></a></li><?php } ?>
   </ul>
    </div>
   ...
   $("#search").click(function(){
        var key=$("#classkey").val();
         window.location.href="/jiayi/index.php/Home/Admin/classlist/searchkey/"+key; 
       })
});
